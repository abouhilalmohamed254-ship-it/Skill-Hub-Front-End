  ...
  return (
    <div className="min-h-full p-4 lg:p-10 space-y-10 lg:space-y-16 bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-950 dark:to-neutral-900">
      <div className="max-w-6xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl lg:text-5xl font-bold text-neutral-900 dark:text-neutral-50 mb-4 lg:mb-6">
            About
          </h1>
        ...
        <div>
          <h2 className="text-2xl lg:text-4xl font-bold text-neutral-900 dark:text-neutral-50 mb-4 lg:mb-6">Team</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 lg:gap-8">
            <div className="bg-gradient-to-br from-white/80 to-neutral-50/60 dark:from-neutral-900/60 dark:to-neutral-900/30 backdrop-blur-sm p-6 lg:p-8 rounded-2xl shadow-sm dark:shadow-black/20 border border-neutral-200/50 dark:border-neutral-800/60 flex flex-col justify-between transition-all duration-200 hover:shadow-md dark:hover:shadow-black/30 hover:scale-[1.01]">
              <div className="flex flex-col items-center">
                <div className="rounded-2xl w-32 h-32 lg:w-40 lg:h-40 bg-gradient-to-br from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-800 shadow-md flex items-center justify-center">
                  <span className="text-4xl lg:text-5xl font-bold text-neutral-500 dark:text-neutral-400">MA</span>
                </div>
                <h3 className="text-xl lg:text-2xl font-bold text-neutral-900 dark:text-neutral-50 mt-5 text-center">
                  Mohammed Amine Rafi
                </h3>
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">(insayd Cyan)</p>
                ...
                <div className="text-center space-y-1">
                  <p className="text-sm text-neutral-700 dark:text-neutral-300 font-medium">Frontend Developer</p>
                  <p className="text-sm text-neutral-700 dark:text-neutral-300 font-medium">UX/UI Designer</p>
                </div>
              </div>
              <div className="mt-6">
        ...
        <div>
          <h2 className="text-2xl lg:text-4xl font-bold text-neutral-900 dark:text-neutral-50 mb-4 lg:mb-6">Technologies</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 lg:gap-8">
            {[
              { name: "Next.js", initials: "N" },
              { name: "Supabase", initials: "S" },
              { name: "Tailwind CSS", initials: "T" },
            ].map((tech) => (
              <div key={tech.name} className="bg-gradient-to-br from-white/80 to-neutral-50/60 dark:from-neutral-900/60 dark:to-neutral-900/30 backdrop-blur-sm p-6 lg:p-8 rounded-2xl shadow-sm dark:shadow-black/20 border border-neutral-200/50 dark:border-neutral-800/60 flex flex-col justify-center items-center gap-5 transition-all duration-200 hover:shadow-md dark:hover:shadow-black/30 hover:scale-[1.01]">
                <div className="w-24 h-24 lg:w-28 lg:h-28 rounded-2xl bg-gradient-to-br from-neutral-100 to-neutral-200 dark:from-neutral-800 dark:to-neutral-700 flex items-center justify-center shadow-inner">
                  <span className="text-3xl lg:text-4xl font-bold text-neutral-600 dark:text-neutral-300">{tech.initials}</span>
                </div>
                <h3 className="text-xl lg:text-2xl font-bold text-neutral-900 dark:text-neutral-50 text-center">{tech.name}</h3>
              </div>
            ))}
          </div>
        </div>
