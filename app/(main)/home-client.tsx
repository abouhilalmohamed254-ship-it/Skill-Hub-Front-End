...
export default function HomeClient() {
  ...
  function handleDashboard() {
    if (user) {
      ...
      // The login form is managed by the parent AppShell, so we dispatch a custom event
  ...
  return (
    <div className="relative w-full h-full bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-950 dark:to-neutral-900">
      ...
      <div className="flex flex-col justify-center items-center h-full px-6 max-w-4xl mx-auto">
        <h1 className="text-6xl sm:text-7xl lg:text-9xl font-bold text-neutral-900 dark:text-neutral-50 mb-4 lg:mb-6 leading-tight">
          Skill Hub
        </h1>
        <LayoutGroup>
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-6 sm:mb-8 lg:mb-10">
            <motion.p
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-bold text-neutral-700 dark:text-neutral-300 leading-tight"
            >
              Learn
            </motion.p>
            <RotatingText
              texts={["Anything", "Languages", "Design", "Development", "Marketing", "Business"]}
              mainClassName="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-bold px-3 sm:px-4 md:px-5 lg:px-6 bg-gradient-to-br from-neutral-900 to-neutral-950 dark:from-neutral-100 dark:to-neutral-50 text-neutral-50 dark:text-neutral-900 overflow-hidden py-1 sm:py-2 md:py-2 lg:py-3 flex items-center justify-center rounded-lg"
              staggerFrom="last"
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
              exit={{ y: "-120%" }}
        ...
        <div className="flex flex-col sm:flex-row gap-4 lg:gap-6 text-base lg:text-lg w-full sm:w-auto">
          ...
          <button
            ...
            className="px-8 lg:px-10 py-3 lg:py-4 bg-white/50 dark:bg-neutral-800/30 text-neutral-900 dark:text-neutral-50 rounded-xl font-semibold border border-neutral-300 dark:border-neutral-700 hover:bg-neutral-200/70 dark:hover:bg-neutral-700/50 hover:shadow-md hover:scale-105 transition-all duration-200"
          >
            Dashboard
          </button>
        </div>
